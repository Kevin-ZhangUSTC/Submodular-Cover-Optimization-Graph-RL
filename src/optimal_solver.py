...
# ──────────────────────────────────────────────────────────────────────────────
# Greedy oracle (moved from src/imitation.py after imitation removal)
# ──────────────────────────────────────────────────────────────────────────────

from typing import List as _List, Tuple as _Tuple


def get_greedy_trajectory(env) -> _Tuple[_List[int], float]:
    ...
    env : SensorSelectionEnv
        The environment to solve.  Its state is **not** modified; this
        function operates on a temporary copy of the selection state.
